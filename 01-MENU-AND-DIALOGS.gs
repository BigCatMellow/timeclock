...
function onOpen() {
  ...
  ui.createMenu('⏰ Time Clock')
    .addItem('✏️ Manual Time Entry', 'openManualTimeEntry')
    .addSeparator()

    .addItem('🚗 Generate Late Arrivals Report', 'showCalendarDatePicker')
    .addItem('📋 Student History Report', 'showStudentHistoryDialog')
    .addItem('🗑️ Delete Old Late Arrivals Reports', 'deleteOldTardyReports')
    .addSeparator()

    .addItem('✉️ Generate Emails from Report', 'showEmailGenerationDialog')
    .addSeparator()

    .addSubMenu(
      ui.createMenu('📨 Email Status Tracker')
        ...
        .addItem('⚙️ Tracker Manager', 'showEmailTrackerManager')
    )
...
function openManualTimeEntry() {
  ...
  const html = HtmlService.createHtmlOutput(`
    ...
    <html>
      ...
      <body>
        <p>Open the manual student time-entry page:</p>
